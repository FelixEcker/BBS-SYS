...
public class Logger {
	...
	public void info(String msg) {
		printStream.printf("%s [%s]:[INFO] %s\n", Util.getDateTimeString(), name, msg);
	...
	public void infof(String msg, Object... objects) {
		printStream.printf("%s [%s]:[INFO] %s", Util.getDateTimeString(), name, String.format(msg, objects));
		logWriter.printf("%s [%s]:[INFO] %s", Util.getDateTimeString(), name, String.format(msg, objects));
		Logger.UNIVERSAL_LOGFILE_WRITER.printf("%s [%s]:[INFO] %s", Util.getDateTimeString(), name, String.format(msg, objects));
	}
	...
	public void warnf(String msg, Object... objects) {
		printStream.printf("%s [%s]:[WARN] %s", Util.getDateTimeString(), name, String.format(msg, objects));
		logWriter.printf("%s [%s]:[WARN] %s", Util.getDateTimeString(), name, String.format(msg, objects));
		Logger.UNIVERSAL_LOGFILE_WRITER.printf("%s [%s]:[WARN] %s", Util.getDateTimeString(), name, String.format(msg, objects));
	}
	...
	public void errf(String msg, Object... objects) {
		printStream.printf("%s [%s]:[ERROR] %s", Util.getDateTimeString(), name, String.format(msg, objects));
		logWriter.printf("%s [%s]:[ERROR] %s", Util.getDateTimeString(), name, String.format(msg, objects));
		Logger.UNIVERSAL_LOGFILE_WRITER.printf("%s [%s]:[ERROR] %s", Util.getDateTimeString(), name, String.format(msg, objects));
	}
	...
	public static PrintWriter UNIVERSAL_LOGFILE_WRITER = null;
